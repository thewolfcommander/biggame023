...
var RUNTIME = 3000; // how long al slots spin before starting countdown
...
function preloadImages( images, callback ) {
	...
	asset.img = new Image();
	asset.img.src = 'https://github.com/neo-0224/soundJSFiles/blob/master/' + asset.id+'.png?raw=true';
